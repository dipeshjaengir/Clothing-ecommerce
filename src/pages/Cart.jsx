...
const Cart = () => {
  ...
  if (checkoutStep === 'loading') {
    return (
      <div className="pt-28 pb-24 bg-luxury-bg text-white font-manrope min-h-screen flex flex-col justify-center items-center text-center">
  ...
  if (checkoutStep === 'success') {
    return (
      <div className="pt-28 pb-24 bg-luxury-bg text-white font-manrope min-h-screen flex flex-col justify-center items-center text-center px-6">
        ...
        <h2 className="font-syne text-3xl md:text-5xl font-black tracking-wider text-white uppercase mt-2">
        ...
        <button
          ...
          className="mt-8 px-8 py-4 bg-white text-black font-syne font-bold text-xs tracking-widest rounded-full hover:bg-accent transition-colors"
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
              ...
              {cart.map((item) => (
                ...
                >
                  ...
                  <img
                    ...
                    className="w-24 h-32 object-cover rounded-xl bg-luxury-border flex-shrink-0"
                  />
                  ...
                  <div className="flex-grow flex flex-col justify-between">
                    <div>
                      <div className="flex justify-between items-start gap-4 pr-8">
                        <h3 className="font-syne font-bold text-sm md:text-base text-white tracking-wider">
                    ...
                    <div className="flex justify-between items-end mt-4">
                      ...
                      <div className="flex items-center border border-luxury-border rounded-lg bg-luxury-bg/50">
                        <button
                          ...
                          className="px-2.5 py-1 text-luxury-muted hover:text-white transition-colors"
                        >
                          <Minus className="w-3.5 h-3.5" />
                        </button>
                        <span className="px-3 text-xs font-bold text-white font-manrope">{item.quantity}</span>
                        <button
                          onClick={() => updateQuantity(item.product.id, item.selectedSize, item.selectedColor, item.quantity + 1)}
                          className="px-2.5 py-1 text-luxury-muted hover:text-white transition-colors"
                        >
            ...
            <div className="space-y-6">
              ...
              <div className="p-8 rounded-3xl bg-luxury-card/30 border border-luxury-border/80 shadow-premium space-y-6">
                <h3 className="font-syne font-bold text-base tracking-wider text-white uppercase border-b border-luxury-border pb-4">
                  ORDER SUMMARY
                </h3>
                ...
                <div className="space-y-4 text-xs font-semibold tracking-wider text-luxury-muted font-manrope">
                  ...
                  <div className="flex justify-between text-sm text-white font-extrabold font-manrope pt-2">
              ...
              <div className="p-6 rounded-2xl bg-luxury-card/20 border border-luxury-border/80 shadow-premium">
                ...
                <form onSubmit={handleApplyCoupon} className="flex gap-2">
                  <input
                    ...
                    className="flex-grow px-4 py-2.5 rounded-xl bg-luxury-card border border-luxury-border text-xs outline-none text-white focus:border-accent font-manrope placeholder-luxury-muted uppercase tracking-wider"
                  />
                  <button
                    type="submit"
                    className="px-4 py-2.5 bg-white text-black font-syne font-bold text-[10px] tracking-widest rounded-xl hover:bg-accent transition-colors"
                  >
                    APPLY
                  </button>
                </form>
