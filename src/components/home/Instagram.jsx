            ...
            return (
              ...
              >
                ...
                <img
                  ...
                  className="w-full h-full object-cover transition-transform duration-[1200ms] cubic-bezier(0.16, 1, 0.3, 1) group-hover:scale-105 opacity-80 group-hover:opacity-100"
                  loading="lazy"
                />
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-all duration-300 backdrop-blur-xs">
                  <div className="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-secondary scale-75 group-hover:scale-100 transition-all duration-300">
                    {/* SVG Instagram logo */}
